...
| 대상 | 파일 | 설명 |
|------|------|------|
| 입문 (체험형 30분) | [`docs/harness/presentation-intro.html`](docs/harness/presentation-intro.html) | 파이프라인 실습 데모 중심 |
| 입문 (스킬 만들기 30분) | [`docs/harness/presentation-intro2.html`](docs/harness/presentation-intro2.html) | 나만의 스킬 워크샵 |
| 심화 | [`docs/harness/presentation-intro3.html`](docs/harness/presentation-intro3.html) | 품질 게이트·롤백·커맨드 체계 |
| 전체 | [`docs/harness/presentation.html`](docs/harness/presentation.html) | 하네스 전체 개요 (원본) |
...
└── docs/
    ...
    └── harness/                 # 하네스 가이드 문서
        ├── presentation.html         # 발표자료 (전체 원본)
        ├── presentation-intro.html   # 입문 1부 — 체험형 실습
        ├── presentation-intro2.html  # 입문 2부 — 스킬 만들기
        ├── presentation-intro3.html  # 입문 3부 — 심화
